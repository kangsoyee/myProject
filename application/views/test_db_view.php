...
<form action="http://www.kangse2942.com/test_db/search" method="post" name="search_form">
	<input type="text" name="search">
	<input type="submit" value="search">
</form>

<form action="http://www.kangse2942.com/test_db/sort" method="post" name="sort_form">
	...
	<select id="select" name="select_dir">
...
<script>
	function saveSubmit(){
		...
		form.action = 'http://www.kangse2942.com/test_db/save';
		form.submit();
	}
	function deleteSubmit(){
		var form = document.forms['test_form'];
		form.action = 'http://www.kangse2942.com/test_db/delete';
		form.submit();
	}
	function editSubmit(){
		var form = document.forms['test_form'];
		form.action = 'http://www.kangse2942.com/test_db/edit';
		form.submit();
	}
</script>
</body>
